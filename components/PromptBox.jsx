...
const PromptBox = ({setIsLoading, isLoading}) => {
    ...
    const sendPrompt = async (e) => {
        ...
        try {
            ...
            // Add the user prompt to the chats and selected chat
            ...
            // Make the API request to send the prompt
    ...
    return (
        <form onSubmit={sendPrompt}
            className={`w-full ${selectedChat?.messages.length > 0 ? "max-w-3xl" : "max-w-2xl"} bg-[#404045] p-4 rounded-3xl mt-4 trasition-all`}>
            <textarea 
