  ...
  return (
    <div>
      <div className="flex h-screen">
        <Sidebar expand={expand} setExpand={setExpland}/>
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-white relative">
          <div className="md:hidden absolute px-4 top-6 flex items-center justify-between w-full">
            <Image onClick={() => (expand ? setExpland(false) : setExpland(true))}
          ...
          (
            ...
            className='relative flex flex-col items-center justify-center-start w-full mt-20 max-h-screen overflow-y-auto'>
